...
**Important: Be sure you entered the right name for the usb you want the system on before executing this command. If you choose the wrong device your data could be damaged or wiped completely. I take no responsibility for loss of data. If you don't know what you are doing, I recommend using the qemu boot instead.**
